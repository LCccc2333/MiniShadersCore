...
public class ReShaderManager {
    ...
    public ReShaderManager(IResourceManager resManager, String jsonName) throws JsonException {
        ...
        try {
            ...
            this.jsonBlendingMode = JsonBlendingMode.func_148110_a(JsonUtils.getJsonObjectFieldOrDefault(jsonobject, "blend", (JsonObject) null));
            ...
            if (this.attributes != null) {
                ...
                while (iterator1.hasNext()) {
                    ...
                    int l = OpenGlHelper.func_153164_b(this.program, s3);
    ...
    public void useShader() {
        ...
        this.jsonBlendingMode.func_148109_a();
        ...
        for (int i = 0; i < this.shaderSamplerLocations.size(); ++i) {
            ...
            if (this.shaderSamplers.get(this.samplerNames.get(i)) != null) {
                ...
                if (j != -1) {
                    ...
                    OpenGlHelper.func_153163_f(OpenGlHelper.func_153194_a(this.program, (CharSequence) this.samplerNames.get(i)), i);
                }
            }
        }
    ...
    private void setupUniforms() {
        ...
        for (int j = 0; i < this.samplerNames.size(); ++j) {
            ...
            k = OpenGlHelper.func_153194_a(this.program, s);
            if (k == -1) {
    ...
    private void parseSampler(JsonElement jsonElement) {
        ...
        JsonObject jsonobject = JsonUtils.getJsonElementAsJsonObject(jsonElement, "sampler");
    ...
    private void parseUniform(JsonElement jsonElement) throws JsonException {
        ...
        JsonObject jsonobject = JsonUtils.getJsonElementAsJsonObject(jsonElement, "uniform");
        String s = JsonUtils.getJsonObjectStringFieldValue(jsonobject, "name");
        
        int i = ReShaderUniform.parseType(JsonUtils.getJsonObjectStringFieldValue(jsonobject, "type"));
